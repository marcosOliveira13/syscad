                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                    ...
                                                                    $result_pessoa = "SELECT * FROM pessoa WHERE nome LIKE '%$nome%'";
...
// salva na variavel o que foi pesquisado

$nome = $_GET['busca'];

$busca = "SELECT * FROM pessoa WHERE nome LIKE '%$nome%' LIMIT 5";
$resultado_busca = mysqli_query($conexao, $busca);
while ($rows_busca = mysqli_fetch_array($resultado_busca)) {
    echo "Nome do Paciente ".$rows_busca['nome']."<br>";
}
 ?>
